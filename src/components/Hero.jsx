        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-6">
            <div className="hs-banner">
              <img src={imgUrl} title alt="Admin" className='img-hero' />
            </div>
          </div>
        </div>
        <FloatingWhatsApp
      phoneNumber="6282123540030"
      email="varits.gorga106@gmail.com"
      accountName="Varits Gorga"
      avatar="/images/pp WA.svg"
      style={{
